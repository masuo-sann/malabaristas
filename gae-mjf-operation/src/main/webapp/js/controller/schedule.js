MALABARISTAS_APP.controller('ScheduleCtrl',["$scope", "$route","homeRepo","$window", "$timeout","SharedDataService", function($scope, $route,homeRepo,$window, $timeout, SharedDataService) {
