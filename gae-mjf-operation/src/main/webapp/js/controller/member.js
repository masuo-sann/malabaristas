MALABARISTAS_APP.controller('MemberCtrl',["$scope", "$route","egoSearchRepo","$window", "$timeout","SharedDataService", function($scope, $route,egoSearchRepo,$window, $timeout, SharedDataService) {
